...
public abstract class ListTest {
    ...
    public void testRetreatMaxCase() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(8, "red", "blue", "green",
                "yellow", "pink", "violet", "black", "grey");
        List<String> list2 = this.createFromArgsRef(7, "red", "blue", "green",
                "yellow", "pink", "violet", "black", "grey");
        /*
         * Call method under test
         */
    ...
    public void testRetreatRandom() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(6, "red", "blue", "green",
                "yellow", "pink", "violet", "black", "grey");
        List<String> list2 = this.createFromArgsRef(5, "red", "blue", "green",
                "yellow", "pink", "violet", "black", "grey");
        /*
         * Call method under test
         */
