...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <4,22,6,4> and s2 = <13, 17, 11>.
     */
    @Test
    public void test3() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(4, 22, 6, 4);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(4, 22, 6, 4);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(13, 14, 5);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
